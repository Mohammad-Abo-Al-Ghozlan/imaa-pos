"use strict";
    ...
    function showNoItemsMessageIfEmpty() {
        var $tbody = $('#invoiceItemsTable tbody');
        // Count only rows that are not the default "no items" row
        var itemRows = $tbody.find('tr').filter(function() {
            return !$(this).hasClass('default-row');
        });
