...
itemSearchInputBoxId.on("keydown", function (e) {
    if (e.key === "Enter") {
...
function addRow(recordObject) {
    ...
    var salePrice = recordObject.sale_price ||
                   recordObject.wholesale_price ||
                   recordObject.purchase_price;

    if (!salePrice || salePrice <= 0) {
        iziToast.error({
            title: "Error",
            message: "Item has no valid sale price"
        });
        return;
    }
...
function addRowToInvoiceItemsTable(
    ...
    var inputQuantity =
        ...
        '">';
    var inputUnitPrice = '<input type="text" name="sale_price[' + currentRowId + ']" class="form-control text-start" value="' + _parseFix(recordObject.sale_price) + '">';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (
                        ...
                        console.log("Exact match found:", data[0]);
                        console.log("Sale price:", data[0].sale_price);
                        searchedItemPrice = _parseFix(data[0].sale_price);
