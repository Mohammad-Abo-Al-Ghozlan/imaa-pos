					...
					<div class="card-body">
						...
						<div class="fm-menu">
							<div class="list-group list-group-flush">
								...
								<a href="javascript:;" class="list-group-item py-1 show_cache"><i class='bx bx-pulse me-2'></i><span>{{ __('app.cache') }}</span></a>
								<a href="javascript:;" class="list-group-item py-1 show_app_log"><i class='bx bx-trash me-2'></i><span>{{ __('app.app_log') }}</span></a>
								<a href="javascript:;" class="list-group-item py-1 show_database"><i class='bx bx-plug me-2'></i><span>{{ __('app.database_backup') }}</span></a>
				...
				<div class="card logo_tab">
					...
					<div class="card-body p-4">
						<form class="row g-3 needs-validation" id="logoForm" action="{{ route('logo.store') }}" enctype="multipart/form-data" method="post">
							...
							<div class="col-md-12">
								<div class="d-md-flex d-grid align-items-center gap-3">
									<x-button type="submit" disabled class="primary px-4" text="{{ __('app.submit') }}" />
									<x-anchor-tag href="{{ route('dashboard') }}" text="{{ __('app.close') }}" class="btn btn-light px-4" />
								</div>
							</div>
						</form>
