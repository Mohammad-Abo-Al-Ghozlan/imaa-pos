...
<form class="" id="invoiceForm" action="{{ route('sale.invoice.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
                            ...
                            <div class="flex-shrink-0">
                                <div class="input-group">
                                    <x-input
                                        type="text"
                                        additionalClasses="datepicker no-pointer"
                                        name="sale_date_display"
                                        :required="false"
                                        value="{{ date('Y-m-d') }}"
                                        readonly />
                            ...
                            <div class="flex-shrink-0 d-flex align-items-center gap-2 pos-actions-container">
                                ...
                                <div class="calculator-icon-container">
                                    <a class="nav-link" href="javascript:void(0);" id="calculator-toggle" title="Calculator">
                                ...
                                @endif
                                <button type="button" disabled class="btn btn-primary rounded-circle d-flex align-items-center justify-content-center hand-btn">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                <x-input type="text" name="prefix_code" :required="true" placeholder="Prefix Code" value="{{ $data['prefix_code'] }}" readonly />
                                <span class="input-group-text">#</span>
                                <x-input type="text" name="count_id" :required="true" placeholder="Serial Number" value="{{ $data['count_id'] }}" readonly />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="serial_number_checkbox">
                                                <label class="form-check-label" for="serial_number_checkbox">{{ __('item.serial_number') }}</label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table mb-0 table-striped table-bordered" id="invoiceItemsTable">
                                            <thead>
                                                <tr class="text-uppercase">
                                                    ...
                                                    <th scope="col" class="d-none serial-column">{{ __('item.serial') }}</th>
    ...
    <div class="{{$themeBgColor}} p-2 fixed-bottom border-top shadow">
        <div class="container-fluid d-flex justify-content-end gap-3">
            ...
            <button type="button" disabled class="btn btn-warning" id="hold_button">Hold</button>
            <button type="button" class="btn btn-success" id="submit_form_with_print">{{ __('app.save_and_print') }}</button>
